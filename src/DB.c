...
const HAPStringCharacteristic accessoryInformationADKVersionCharacteristic = {
    ...
    .properties = {.readable = true,
                   ...
                   .ble = {.supportsBroadcastNotification = false,
                           ...
                           .writableWithoutSecurity = false}},
    .constraints = {.maxLength = 64},
    .callbacks = {.handleRead = HAPHandleAccessoryInformationADKVersionRead,
                  .handleWrite = NULL}};
...
const HAPService accessoryInformationService = {
    ...
    .characteristics = (const HAPCharacteristic *const[]){
        ...
        &accessoryInformationFirmwareRevisionCharacteristic,
        &accessoryInformationHardwareRevisionCharacteristic,
        &accessoryInformationADKVersionCharacteristic, NULL}};

//----------------------------------------------------------------------------------------------------------------------

static const HAPDataCharacteristic
...
static const HAPStringCharacteristic
...
const HAPService hapProtocolInformationService = {
    ...
    .properties = {.primaryService = false,
                   .hidden = false,
                   .ble = {.supportsConfiguration = true}},
    .linkedServices = NULL,
    .characteristics = (const HAPCharacteristic *const[]){
        &hapProtocolInformationServiceSignatureCharacteristic,
        &hapProtocolInformationVersionCharacteristic, NULL}};
...
const HAPService pairingService = {
    ...
    .linkedServices = NULL,
    .characteristics = (const HAPCharacteristic *const[]){
        &pairingPairSetupCharacteristic, &pairingPairVerifyCharacteristic,
        &pairingPairingFeaturesCharacteristic,
        &pairingPairingPairingsCharacteristic, NULL}};
